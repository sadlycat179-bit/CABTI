...
window.CATBTI_CONFIG = {
  ...
  cats: [
    ...
    },
    {
      ...
      biography: "薄荷刚出现时瘦瘦的，嗓音还有点像破锣，后来在大家的照料下逐渐长成了“大号薄荷”。到了猫生中年，它对很多事都淡淡的，只守着熟悉的竹林小路和自己的生活节奏。它曾与柠檬形影不离；柠檬离开后，它瘦了许多，也一直没有再找新的搭档。",
    ...
    },
    {
      ...
      biography: "三宝的存在感像一辆停得稳稳的大卡车：体格醒目，节奏却不慌不忙。它熟悉自己的地盘，也记得谁常来、谁值得靠近；很多温柔都藏在慢吞吞的动作和踏实的陪伴里。只要它安稳待着，周围好像也会跟着安定下来。",
    ...
    },
    {
      ...
      biography: "黛玉对世界的动静格外敏感，风吹草动时会先退半步，安全以后才偷偷把好奇心探出来。它在社媒里既会“自愿放弃高考”，也能和薄荷上演宿敌对决；表面很怂，内心戏和自己的坚持却一样不少。",
    ...
    },
    {
      ...
      biography: "左下角的名字来自初次被拍到时所在的照片角落，可它后来一点也不愿待在关系的角落里。它非常亲人，喜欢被摸摸；从与伙伴们相依为命，到和大逼斗熟识，再到如今与蛋壳形影不离，它总能把日子过成有同伴、有贴贴的生活。",
    ...
    },
    {
      ...
      biography: "蛋壳刚到三教时就靠撒娇、贴贴和漂亮脸蛋迅速积攒了人气。随着资历增长，它从“蛋壳宝宝”一路升级成“蛋壳女王”：爱坐车座，亲人可撸，也会欺猫斗狗；日常不是接受供奉，就是拉着左下角打打闹闹。它很少把想法留到明天，喜欢现在就行动。",
    ...
    },
    {
      ...
      biography: "四喜脾气很冲，连吃饭都能骂骂咧咧，却也是一位极有主见的猫妈妈。孩子们被安置到活动室后，它接受照料，却始终没有放弃对自由的打算；谋划许久，它终于在一个夜晚突破防线，回到自己选择的生活。它不是拒绝被帮助，只是一定要亲自决定归属。",
