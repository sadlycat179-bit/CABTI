...
(async () => {
  ...
  const desktop = await checkPage({ width: 1200, height: 850 }, "qa/latest-result-desktop.png");
  const mobile = await checkPage({ width: 390, height: 844 }, "qa/latest-result-mobile.png");
